...
- a separate `BUY_SUCCESS` reply path should not be required for successful buys; the OFT compose arrival is the success signal and should release source-chain vaulted payment to treasury where applicable

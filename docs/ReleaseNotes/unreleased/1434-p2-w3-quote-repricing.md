...
finalization — computed entirely from finalization-frozen data, with
the day's per-entry ceilings applied unchanged and a conservation
identity proving the walk covered every entry before the quote may
dispatch. The quote travels to the canonical chain on its own wire
...
canonical chain's manual-funding anchor — nothing to compensate.

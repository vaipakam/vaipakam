...
- **Very short bodies don't count.** A body under 40 bytes, not counting spaces, tabs or line breaks, is too short to tell a copy from a coincidence, so only the heading is compared for it.

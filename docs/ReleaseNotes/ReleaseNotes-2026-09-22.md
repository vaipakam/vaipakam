...
Two behaviour-changing merges. One finishes the database move the previous
day's notes describe; the other puts a check on these notes themselves.
Four others landed the same day and are not written up below,
...
The second merge closes a gap in how these notes are produced. Every section
below began as a separate file, and nothing between writing one and
publishing it had ever looked at its heading — so two ways of writing that
heading wrongly had been reaching published notes unnoticed, and both are
visible in the archive. Assembly now refuses those two, before anything is
written or any source file is consumed.
...
<!-- assembled-fragment: 2288-assembly-refuses-a-heading-that-cannot-survive.md sha256=bc1fc636bc21075b6f77ce02768a52facfe729f3ba852c824fd47c8be51196d6 -->

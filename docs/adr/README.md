...
| [ADR-0003](0003-vpfi-time-weighted-discount.md) | Time-weighted accumulator for VPFI fee discounts | Accepted — mechanism superseded (borrower half by #1352; loan-window averaging by T-087 Sub 1.B, recorded #1981) |

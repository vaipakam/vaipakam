...
| **M4 C1–C4** — surplus knob (#1567) + batched repatriation Mode A (#1568) + local keeper-budget credit (#1569) + TokenomicsTechSpec §9 (#1570). See §M4 — C2's scope CHANGED with §3.6a | #1222 tail |
...
| #1222 | Adopt the parked B1–B4 cut with §M3's two corrections (B1 two report fields; two-pass funding in B2/B3); #1331 stays absorbed by B2. **The Phase-C tail is C1–C4, not C1–C2** (#1567–#1570), and **C2's scope changed** with §3.6a — see §M4 |

...
| **M2 — all landed slices** (milestone itself stays IN PROGRESS until **BOTH #1369 AND #1947** land) | #1350→#1359 (specs) · #1352→#1363 (HoldOnly + 20/200 freeze + grandfather resolver) · #1347→#1366 (Full tariff, dark) · #1353→#1371 (loan-side cap, dark) · #1354→#1381 (settlement sweep, dark — **REOPENED**: covers the repayment/early-close paths only; the six recovery entry points, both collateral prepay-SALE terminals and refinance's stored-lender keying are open, #1947) · #1355→#1412 (frontend) · #1356→#1411 (deploy asserts + facet-key drift gate) · **#1351 CLOSED** via the slice series #1397/#1399/#1407–#1410 (D1 ShareOfPool claim SM: storage+knob+stamp, `processUserSideDay`, pricing core, chunked claim, preview-parity) with its remit-side prerequisite delivered by B2-d2 | Settlement-sweep long tail closed by follow-up cards #1383 (PR-B2/B3 repay/preclose/swap families), #1384 (extension repricing), #1391 (offset close-out), #1392 (sold-position discount continuity). **TWO conditions remain, and BOTH gate the milestone.** (i) The deferred origination-auth slice **#1369** (see the remaining map): signed-offer makers cannot authorize Full, and matched fills ignore the lender offer's `creatorFull`. (ii) The **REOPENED settlement sweep, #1947**: the six recovery entry points, both collateral prepay-SALE terminals and refinance's stored-lender keying are open. The M2 milestone must NOT be checked off on the umbrella tracker until **both** land — #1369 alone is not sufficient, and an earlier revision of this row named only #1369, which would have directed the tracker to close M2 over a live fund-loss path. Only the listed slices are done |

...
0. ⛔ **#1460 must be CLOSED first — a THIRD arming gate, independent of
   the two below.** `RewardClaimFacet` debits `recycleBucket` by a claim's

...
- **Frontend Warning:** Before signature, the refinance flow should tell the borrower that the old lender is repaid with principal plus full-term interest, not merely accrued-to-date interest. Refinance must not add a rate shortfall on top of that full-term interest because the original lender exits the loan fully repaid.
- **Process:**
  ...
  7.  The selected refinance offer must not reduce Lender A's protected closure economics for the original loan. In practice, Lender A exits fully protected once the refinance repays principal plus the old loan's full-term interest under the early-repayment policy. The new loan's lower future yield is a borrower/new-lender term and must not create an additional shortfall payment to Lender A.
...
- A lower-yield replacement offer does not create an extra shortfall on top of the original loan's full-term interest, because the original lender exits the loan fully repaid.

...
- Claim Center should show interaction-reward waiting states when finalization, broadcast, or mirror-chain funding has not reached the active chain yet. The UI should not invite the user to submit a reward claim that is expected to fail only because the mirror's VPFI budget has not arrived.

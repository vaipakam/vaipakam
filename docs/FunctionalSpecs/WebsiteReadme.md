...
- a described capture scope should name the failure classes actually recorded rather than implying all of them; "whenever something fails" is a broader claim than a client that records only crashed screens and failed transactions can support

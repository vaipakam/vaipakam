...
- **deliberately deferred**: the dispatch-cutoff refusal (the canonical chain refusing to dispatch a compensation too close to the day's expiry) ships with the lapse terminals whose clocks it guards; the post-lapse quarantine branch exists but is unreachable until those terminals arm

...
- a caveat is shown only where the condition it describes is actually present. A standing note explaining how to reconcile two figures that currently agree, or describing a total the surface is withholding, asserts a discrepancy the reader cannot find; a caveat that does not match what is on screen teaches a reader to discount the ones that do

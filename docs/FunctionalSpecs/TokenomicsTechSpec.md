...
- the ratified **90-day activation-notice floor** is additionally explicit: every activation of the horizon — including a re-activation after governance dark-resets the knob — re-grants every entry, however stale its clock stamp, at least 90 days of fresh runway before it can expire. A dark interval can therefore never be silently counted against dormant claimants

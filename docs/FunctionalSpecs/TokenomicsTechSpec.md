...
- the **older broadcast wire remains accepted unchanged**: an in-flight pre-upgrade packet still applies in full, just without a clock — such a day is neither lapse-eligible nor priceable as a zeroed day until healed. A day finalized before this machinery existed has no authentic clock at all and keeps broadcasting on the older wire permanently

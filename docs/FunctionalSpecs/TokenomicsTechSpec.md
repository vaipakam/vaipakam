...
- **when a chain cannot pay for want of funding, the affected day DEFERS and the walk moves on** — it must never stop the chain's day-by-day progress. Stopping strands every later day behind it, including days the canonical chain intentionally never funds because the receiving chain covers them entirely from its own balance, or because the day's liability rounds to nothing. A deferred day becomes payable the moment its funding arrives, and the claim can be retried immediately

...
contract DeployTestnetMocks is Script {
    ...
    function run() external {
        ...
        address liquidPool = univ3.createPool(liquidToken, weth, 3000, SQRT_PRICE_X96_ONE, MOCK_POOL_LIQUIDITY);
    ...
    function _adapterRegistered(address diamond, address adapter) private view returns (bool) {

...
contract RewardRemittanceFacetTest is SetupTest {
    ...
    function test_Ingress_RecordsReceivedFromRegisteredReceiver() public {
        ...
        vm.prank(rcv);
        remit.onRewardBudgetReceived(address(vpfiTok), 123e18, _days(1), CHAIN_BASE, 0);
    ...
    function test_Ingress_RevertsForNonReceiver() public {
        ...
        remit.onRewardBudgetReceived(address(vpfiTok), 1e18, _days(1), CHAIN_BASE, 0);
    }
    ...
    function test_Ingress_RevertsOnTokenMismatch() public {
        ...
        remit.onRewardBudgetReceived(address(0xDEAD), 1e18, _days(1), CHAIN_BASE, 0);
    }

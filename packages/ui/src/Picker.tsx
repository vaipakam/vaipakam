...
// Picker + ChainPicker share one stylesheet — both live in
// packages/ui/src/ as of Stage 2d, so the import is now sibling-
// relative again instead of going through the package exports map.

...
const FRIENDLY_ERROR_MESSAGES: Record<string, string> = {
  ...
  '0x667ecf9d': 'Vault withdraw failed — please retry.',
  '0x650f4007': 'Vault resolution failed — please retry.',
  '0x601d5b92': 'Vault transfer failed — please retry.',
...
const KNOWN_ERROR_SELECTORS: Record<string, string> = {
  ...
  '0x667ecf9d': 'VaultWithdrawFailed()',
  '0x650f4007': 'VaultResolutionFailed()',
  '0x601d5b92': 'VaultTransferFailed()',
  ...
  '0xe3afb2e8': 'GetUserVaultFailed(string)',

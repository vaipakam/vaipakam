...
const copySource = {
  ...
  earlyRepay: {
    ...
    options: {
      ...
      repayPartialDesc:
        'Pay down some of the principal now. The loan stays open, but future interest is charged on the smaller balance.',
      ...
      offsetCost:
        'You put up fresh money to lend now; at completion you also pay the interest built up so far plus any rate top-up for your current lender.',

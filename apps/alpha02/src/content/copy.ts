...
export const copy = {
  ...
  support: {
    ...
    privacy:
      'Sending stores your message, the reply address if you gave one, and — only if you ticked the box — the health details above, on Vaipakam’s support service under your ticket number. Your full wallet address is never included in the health details.',

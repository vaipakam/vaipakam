...
const API_INDEX = {
  ...
  // The connected app. Still the LEGACY host: `app.vaipakam.com` is not
  // bound yet (#1854), and this catalog is consumed by automated clients,
  // so advertising a dead URL here is worse than a stale-but-served one.
  // Flip with the rest of the cutover — see APP_TARGET in
  // apps/www/src/lib/appUrl.ts.
  app: 'https://defi.vaipakam.com/',
  conventions: {
    chainParam:

 ...
 * Footer link out to them via ONE helper: `appUrl(...)`, for every
 * destination including Analytics and the Protocol Console, which
 * are now ported to `apps/app` (#1959). A second helper existed
 * only while those two were served by a single deployment; with the
 * port done, every link moves together at the cutover, which is the
 * property this indirection exists to guarantee. Cross-domain

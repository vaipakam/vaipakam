...
取决于 loan 是如何结束的：部分 liquidation 之后，那是未被卖出的
collateral，仍留在您的 vault 中；而在可交易 collateral 的 default 之后，
整个 basket 会被卖出，剩余部分以 loan 自身的 asset 到您手中。在无法定价的 collateral 上发生

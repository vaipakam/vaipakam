...
வைத்திருந்தால் protocol fees-இல் discount கிடைக்கும். நீங்கள்
இணைந்துள்ள chain-இல், இந்தக் கார்டு பின்வரும் விஷயங்களை காட்டுகிறது:

- இப்போது உங்கள் wallet-இல் எவ்வளவு VPFI உள்ளது.
- உங்கள் vault-இல் எவ்வளவு உள்ளது (அது உங்கள் discount tier-க்கு கணக்கிடப்படும்).
...
வெகுமதிகள் **இயங்குதள தொடர்பிலிருந்து** வருகின்றன — நீங்கள்
பங்கேற்கும் ஒவ்வொரு கடனுக்கும், எந்தப் பக்கத்திலும், ஒவ்வொரு
நாளும் கொஞ்சம் சம்பாதிக்கிறீர்கள். நீங்கள் இருக்கும் chain-இல்
VPFI-ல் செலுத்தப்படுகிறது, பாலம் தேவையில்லை.

வரிசையின் வலதுபுறத்தில் ஒரு சிறிய ஷெவ்ரான் அம்பு உள்ளது.
Claim Center-ல் உள்ள முழு claim அட்டைக்கு நேரடியாகச் செல்ல
...
சிறிய பகுதி (`{liveValue:treasuryFeeBps}`%) settlement-இல் protocol treasury-க்குச்
செல்கிறது.
...
default அல்லது liquidation நடந்தாலும் ஒருமுறை பார்த்துவிடுங்கள்.
கடனுக்கும் அதை முடிக்கும் செலவுக்கும் தேவையான மதிப்பு மட்டுமே
எடுக்கப்படும்; அதற்கு மேல் உள்ளது உங்கள் பெயரில் பதிவாகும். அது எந்த
வடிவில் இருக்கும் என்பது loan எப்படி முடிந்தது என்பதைப் பொறுத்தது:
collateral exchange வழியாக விற்கப்பட்டால், மீதி
loan-இன் சொந்த asset ஆக உங்களை வந்தடையும். விற்கப்படாமல்
கையளிக்கப்பட்டால், collateral-ஏ உங்களுக்குக் காத்திருக்கும். ஒன்றுக்கு மேற்பட்ட வழிகளில் அது கையளிக்கப்படும்; loan எப்படி முடிந்தது
என்பதைப் பொறுத்தது அல்ல அவை: liquidator தள்ளுபடியில் நேரடியாக
எடுத்துக்கொள்வது, விற்கப்படாமல் protocol-இன் உள்ளேயே எதிர்த்திசை
position-உடன் பொருத்தப்படும் close-out, அல்லது நடக்கவே முடியாத ஒரு விற்பனை — அங்கு collateral கிடைக்கும் — claim செய்யும்போது lender வேலை செய்யும்
ஒரு quote கொண்டுவந்தால் ஒழிய; வந்தால் loan-இன் சொந்த asset-இலேயே பணம்
வரும். பெரும்பாலானவற்றில் quote இருப்பதில்லை. வழக்கமான
liquidation-உம் default-உம் exchange-க்குச் செல்லும் முன் அந்த உள்ளகப்
பொருத்தத்தைத் தேடுகின்றன; எனவே இவ்விரண்டிலும் எதுவும் எப்போதும் ஒரே
வடிவத்தில் முடிவதில்லை; loan எப்படி முடிந்தது என்பதிலிருந்து
ஊகிக்காமல் claim-ஐப் படியுங்கள். தள்ளுபடியில் நேரடியாக எடுப்பது
விதிவிலக்கு; அது எதிர்த்திசையில் உறுதியானது: அது ஒருபோதும்
விற்பதில்லை, எனவே எப்போதும் collateral-ஐயே விட்டுச்செல்லும். விலை மதிப்பிட முடியாத collateral மீதான default-இல்
பெரும்பாலும் முழு basket-உம் போய், எதுவும் மிஞ்சாது — இந்த வழியில் அதுவே விதி, விளைவு அல்ல. கட்டண rebate திரும்புமா என்பது loan எப்படி முடிந்தது என்பதைப்
பொறுத்தது: நிறுத்தப்பட்ட VPFI கட்டண வழியில் உள்ள loan-இலும்
எந்த proper close-இல் Loan Initiation
Fee-க்காக வைக்கப்பட்டிருந்த VPFI-ன் rebate
தீர்க்கப்படும் — தொகை settle ஆகும் தருணத்தில் உங்கள்
தள்ளுபடியைப் பொறுத்தது; அப்போது எதுவும் இல்லையெனில் முழுத் தொகையும்
பறிமுதல் ஆகும். முழுப் பறிமுதல் default அல்லது liquidation-இல் நிகழும்; prepay
விற்பனையால் மூடப்பட்ட loan-இல் தற்போது இது வழங்கப்படுவதே இல்லை —
அந்த வழியில் எதிர்பார்க்க வேண்டாம். claim உங்கள்
borrower position NFT-ஐ consume செய்கிறது. இதன் எதிர்மறை உண்மையல்ல:
liquidation-க்குப் பிறகு NFT எஞ்சியிருப்பது, ஏதோ ஒன்று உங்களுக்காகக்
காத்திருக்கிறது என்பதற்குச் சான்று அல்ல. மீதி ஒன்றும் இல்லாத போது
பெறுவதற்கு எதுவும் இல்லை, முயற்சி மறுக்கப்படும், NFT இருந்தாலும்
இருக்கும். NFT-ஐ ஒரு வாக்குறுதியாக எடுத்துக்
கொள்ளாமல், claim என்ன சொல்கிறது என்பதைப் படியுங்கள்.
...
VPFI ஒரு Chainlink CCIP token; அதனால் official bridge மூலம்
ஆதரிக்கப்படும் chains இடையே நகர்ந்து, நீங்கள் இணைந்திருக்கும்
எந்தச் chain-இலும் உங்கள் wallet-க்கு வந்துசேரும்.
...
### VPFI-ஐ உங்கள் vault-இல் deposit செய்யவும்

உங்கள் wallet-இல் உள்ள VPFI discount tier-க்கு கணக்கிடப்படாது.
fee discount-ஐ unlock செய்ய, VPFI-ஐ நீங்களே vault-க்கு நகர்த்த
வேண்டும். இது எப்போதும் வெளிப்படையான one-click action — நீங்கள்
அனுமதிக்காமல் ஆப் உங்கள் VPFI-ஐ நகர்த்தாது. ஒரு transaction
(அல்லது ஆதரிக்கும் chains-இல் ஒரு signature) போதும்.

<a id="buy-vpfi.unstake"></a>

### vault-இலிருந்து VPFI-ஐ unstake செய்யவும்
...
Vaipakam உங்களுக்கு ஒரு **platform-interaction reward** வழங்குகிறது:
நீங்கள் பங்கேற்கும் loan உண்மையில் settle செய்யும் ஒவ்வொரு டாலர்
வட்டிக்கும், community-wide reward pool-இன் தினசரி பங்கில் இருந்து
உங்களுக்கு rewards கிடைக்கும்.

Rewards VPFI-இலேயே வழங்கப்படும்; நீங்கள் இணைந்துள்ள chain-இல்
...
ஒரு பட்டன் ஒரே transaction-இல் உங்கள் accrued rewards-ஐ claim
செய்கிறது. interaction-pool பங்கு நாளுக்கு ஒரு முறை settle
ஆகிறது; எனவே கடைசி settlement-க்கு பிறகு நீங்கள் ஏதாவது
ஈட்டியிருந்தால், அடுத்த daily window முடிந்த சிறிது நேரத்திற்குப்
பிறகே அது live ஆகும்.
...
- **Claim** — loan settle ஆனவுடன், முழு repayment-இல் உங்கள்
  collateral-ஐ திருப்பித் தருகிறது. Default-இல் surplus மிச்சம்
  இருக்கலாம்: கடனுக்கும் அதை முடிக்கும் செலவுக்கும் தேவையான அளவு
  collateral மட்டுமே எடுக்கப்படும்; அதற்கு மேல் நீங்கள் வைத்திருந்தது
  உங்கள் claim ஆகப் பதிவாகும். அது என்ன என்பது வழியைப் பொறுத்தது —
  Claim Center பகுதியைப் பார்க்கவும். நிறுத்தப்பட்ட வழியில்
  வைக்கப்பட்டிருந்த VPFI, default அல்லது liquidation-இல் மட்டுமே
  பறிமுதல் ஆகும்; எந்த proper close-இல்
  rebate தீர்க்கப்படும் (பூஜ்ஜியமாகவும் இருக்கலாம்).

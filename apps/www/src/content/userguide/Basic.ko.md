...
- **스테이킹 수익** — Vault에 보관하는 모든 VPFI에 대해
...
vault의 VPFI는 자동으로 "스테이킹"되어 5% APR을 얻습니다.
...
VPFI를 구매하면 wallet에 들어가며 vault에는 들어가지 않습니다.
fee discount와 5% staking yield를 얻으려면 직접 vault로 옮겨야
...
1. **Staking** — vault에 둔 VPFI는 자동으로 5% APR을 earn합니다.
...
VPFI를 vault에서 wallet으로 옮깁니다. wallet에 들어가면 5% APR

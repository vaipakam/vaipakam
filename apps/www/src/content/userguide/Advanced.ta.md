...
- **HF-liquidation அல்லது default** — இருந்தாலும் பார்த்துவிடுங்கள்;
  ...
  விற்கப்படாத பகுதி உங்கள் vault-இல் encumbered ஆக இருப்பது இரண்டு
  close-out-களில்: liquidator அதை விற்காமல் தள்ளுபடியில் நேரடியாக
  எடுத்துக்கொள்ளும்போது, மற்றும் விற்பனை நிறைவேறாமல் collateral
  அப்படியே பங்கிடப்படும்போது. பகுதி liquidation என்பது close-out-ஏ அல்ல —

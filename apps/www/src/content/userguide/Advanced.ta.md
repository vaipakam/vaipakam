...
நீங்கள் ஒரு acceptable offer-ஐ கண்டறிந்து **Offer-ஐ match செய்**-ஐ
click செய்தால், dapp **Match-ஐ உறுதி செய்** modal-ஐ திறக்கிறது,
இது match செய்யப்பட்ட value-ஐ (gross OpenSea offer amount — diamond
...
actually distribute செய்யும் net modal-இன் முக்கியமாக காட்டப்படும் amount-ஐ விட
...
- **Modal-இல் match செய்யப்பட்ட value-ஐ confirm செய்.** Modal gross

...
이동합니다. 이 escrow는 당신만 control하는 private vault입니다. borrower가
...
- **NFT는 escrow에 남아 있습니다**; renter가 직접 hold하지 않습니다. 대신
...
rental이 끝나면(expiry 또는 default로), NFT는 owner의 escrow로 돌아갑니다.
...
어떤 chain의 escrow에 VPFI를 hold하면, 그 chain에서 참여하는 loans의 protocol
fees가 discount됩니다.
...
VPFI를 escrow로 move하면 그 순간부터 earn합니다. 밖으로 move하면 accrual은
멈춥니다.

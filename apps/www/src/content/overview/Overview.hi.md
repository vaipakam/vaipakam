...
Vaipakam एक vault-to-vault lending प्लेटफ़ॉर्म है। आप assets lend करके
...
USDC मिलते हैं। (**VPFI** रखने पर यह fee कम हो जाती है — बशर्ते borrower ने
discount सेटिंग चालू कर रखी हो और उधार दिया गया asset liquid हो — इसलिए
उसे 1,000 में से ज़्यादा मिलता है। Discount fee में से ही कट जाता है,
...
- **Mainnet से पहले ऑडिट लंबित।** Mainnet लॉन्च से पहले थर्ड-पार्टी सुरक्षा समीक्षा आवश्यक है। ऑडिट रिपोर्ट और bug bounty scope उपलब्ध होने पर प्रकाशित किए जाएँगे।
...
**VPFI** Vaipakam का protocol token है। यह दो काम करता है:
...
holding जिस दिन से शुरू हुई उसी से गिनी हुई — आपने जो hold किया, उसका
time-weighted average** होता है। फिर उसे **उस holding के शुरू होने के
बाद से आप जिस सबसे नीचे के tier तक गिरे, वहीं तक घटा दिया जाता है** —
यह पीछे 30 दिन तक देखता है, गिरावट तब भी गिनी जाती है जब आप उसी दिन
दोबारा top up कर लें, और यह look-back ऊपर वाली averaging window से अलग
अपना history है। जब तक आप **लगातार** शून्य से ऊपर का balance कम-से-कम
तय दिनों तक hold नहीं करते, तब तक कोई discount मिलता ही नहीं; balance
शून्य होते ही वह घड़ी फिर से शुरू हो जाती है। window और वह minimum,
दोनों protocol की settings हैं।

इसलिए loan end होने से ठीक पहले top up करने से कोई फ़ायदा नहीं। ध्यान
दीजिए कि काम कौन सा नियम करता है: अगर आप पहले से hold कर रहे हैं तो
minimum period पहले ही पूरा हो चुका है और वह रास्ता नहीं रोकता — यह
सबसे नीचे के tier वाला नियम है जो आपकी rate को उसी पर रखता है जो आपने
सच में बनाए रखी।
...
- **Bridge it** — VPFI एक Chainlink CCIP CCT token है, इसलिए official
  bridge का इस्तेमाल करके supported chains के बीच move करता है। आप VPFI
  को open market पर भी हासिल कर सकते हैं जहां वह trade होता है।
...
अगर आप सिर्फ **अपनी protocol fees कम** करना चाहते हैं, तो VPFI को
**Dashboard** page पर अपने vault में deposit करें। बस इतना ही — आपका
fee-discount tier उसी moment से automatically लागू हो जाता है।

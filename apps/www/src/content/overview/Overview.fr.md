...
reçoit donc `{liveValue:exampleBorrowerReceives}` USDC, pas 1 000. (Détenir des **VPFI** réduit
ces frais, si bien que l'emprunteur conserve davantage des 1 000 — la
remise est déduite directement des frais, elle n'est pas remboursée
ensuite. Plus de détails sur VPFI ci-dessous.)

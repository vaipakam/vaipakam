...
vault-ல் பாதுகாப்பாக வைத்திருக்கும்.
...
உங்கள் **Vaipakam Vault**-க்கு நகர்கிறது. இது நீங்கள் மட்டுமே control செய்யும்
...
- உங்கள் 1,000 USDC உங்கள் vault-லிருந்து அவருடைய vault-க்கு நகர்கிறது
- அவருடைய WETH collateral-ஆக அவருடைய vault-ல் lock ஆகிறது
...
treasury-க்கு செல்கிறது. அதனால் borrower 1,000 அல்ல, `{liveValue:exampleBorrowerReceives}` USDC பெறுகிறார். (**VPFI**
வைத்திருந்தால் இந்த fee குறையும் — borrower discount அமைப்பை இயக்கியிருக்க
வேண்டும், கடன் கொடுக்கப்படும் asset liquid-ஆக இருக்க வேண்டும் — அதனால்
borrower 1,000-இல் அதிகம் பெறுவார். Discount fee-இலிருந்தே கழிக்கப்படுகிறது,
பின்னர் திருப்பித் தரப்படுவதில்லை. VPFI பற்றி கீழே பார்க்கலாம்.)
...
- **NFT vault-லேயே இருக்கும்**; renter அதை நேரடியாக hold செய்யமாட்டார். அதற்கு
...
Rental முடிந்ததும் (expiry மூலம் அல்லது default மூலம்), NFT owner-ன் vault-க்கு
...
- **Per-user vault.** உங்கள் assets உங்கள் சொந்த vault-ல் இருக்கும். Protocol
...
- **Mainnet முன் audit நிலுவையில் உள்ளது.** Mainnet launch-க்கு முன் third-party security review அவசியம். Audit reports மற்றும் bug bounty scope கிடைக்கும் போது வெளியிடப்படும்.
...
recovered interest-ல் Yield Fee வசூலிக்கப்படாது - failed loan-இலிருந்து protocol
profit செய்யாது.
...
> **Blockchain network gas fee பற்றிய note.** நீங்கள் offer create
> செய்யும்போது, loan accept செய்யும்போது, repay செய்யும்போது, claim
> செய்யும்போது, அல்லது வேறு எந்த on-chain action செய்யும்போது,
> உங்கள் transaction-ஐ block-ல் சேர்க்கும் blockchain validators-க்கு
> ஒரு சிறிய **network gas fee**-ம் நீங்கள் pay செய்கிறீர்கள். அந்த
> gas fee network-க்கு செல்கிறது, **Vaipakam-க்கு அல்ல** - அதே
> chain-ல் எந்த token-ஐ அனுப்புவதற்கும் pay செய்யும் அதே fee தான்.
> அந்த amount chain மற்றும் அந்த நேரத்தின் network congestion-ஐ
> பொறுத்தது, உங்கள் loan size-ஐ அல்ல. மேலே குறிப்பிடப்பட்ட protocol
> fees (Yield Fee `{liveValue:treasuryFeeBps}`%, Loan Initiation Fee
> `{liveValue:loanInitiationFeeBps}`%) network gas-ஐ விட்டு முற்றிலும்
> தனியானவை மற்றும் protocol தானே வசூலிக்கும் ஒரே charges.

---

## VPFI என்றால் என்ன?

**VPFI** என்பது Vaipakam-ன் protocol token. இது இரண்டு விஷயங்களை செய்கிறது:

### 1. Fee discounts

ஒரு chain-ல் உங்கள் vault-ல் VPFI hold செய்தால், அந்த chain-ல் நீங்கள் பங்கேற்கும்
loans-ன் protocol fees-க்கு discount கிடைக்கும்:

| Vault-ல் VPFI | Fee discount |
|---|---|
...
**அதிகபட்சம் 30 நாட்கள் கொண்ட சமீபத்திய window-இல் நீங்கள் hold செய்ததன்
time-weighted average**; அந்த window உங்கள் தற்போதைய holding தொடங்கிய நாளிலிருந்து
கணக்கிடப்படும். அதன் பிறகு **அந்த holding தொடங்கியதிலிருந்து நீங்கள் எப்போதாவது
இறங்கிய மிகக் குறைந்த tier வரை அது தாழ்த்தப்படும்** - இது அதிகபட்சம் 30 நாட்கள்
பின்நோக்கிப் பார்க்கும்; அதே நாளில் மீண்டும் top up செய்தாலும் அந்த இறக்கம் கணக்கில்
கொள்ளப்படும், மேலும் இந்தப் பின்நோக்கல் மேலே உள்ள averaging window அல்ல, தனி history.
பூஜ்ஜியத்திற்கு மேற்பட்ட balance-ஐ **தொடர்ச்சியாக** குறைந்தபட்ச நாட்களுக்கு hold
செய்யும் வரை எந்த discount-ம் கிடைக்காது; balance பூஜ்ஜியத்தை அடைந்தால் அந்தக் கணக்கு
மீண்டும் தொடங்கும். window-ம் அந்தக் குறைந்தபட்சமும் இரண்டுமே protocol settings.

எனவே loan முடிவதற்கு முன் திடீரென top up செய்வதால் பயனில்லை. எந்த விதி வேலை
செய்கிறது என்பதைக் கவனியுங்கள்: நீண்ட காலமாக hold செய்பவருக்கு குறைந்தபட்ச காலம்
ஏற்கனவே நிறைவேறிவிட்டது, அது தடையாக இல்லை - உங்கள் rate-ஐ நீங்கள் உண்மையில்
தக்கவைத்த அளவிலேயே வைத்திருப்பது மிகக் குறைந்த tier விதிதான்.
...
- **Bridge it** - VPFI ஒரு Chainlink CCIP CCT token; அதனால் official bridge மூலம்
  supported chains இடையே நகரும். VPFI trade ஆகும் எந்த open market-லும்
  அதை வாங்கிக்கொள்ளலாம்.
...
உங்கள் **protocol fees-ஐ குறைக்க** மட்டும் விரும்பினால், **Dashboard** page-ல்
VPFI-ஐ உங்கள் vault-க்கு deposit செய்யுங்கள். அதுதான் - உங்கள் fee-discount tier
அந்த நொடியிலிருந்து automatic-ஆக பொருந்தும்.
...
- **No proxy custody.** உங்கள் assets shared vault-ல் அல்ல, உங்கள் சொந்த vault-ல்
...
- **No surprise upgrades.** Vault upgrades gated; mandatory upgrades app-ல் தோன்றி

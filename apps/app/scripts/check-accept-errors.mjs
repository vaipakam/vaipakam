 ...
 *
 * Run: node apps/app/scripts/check-accept-errors.mjs
 * Wired into `pnpm --filter @vaipakam/app typecheck`.
 */
...
if (mismatch) {
  ...
  fail(
    `AcceptError mirror is out of date with OfferAcceptFacet.sol:\n${rows.join('\n')}\n\n` +
      `Update apps/app/src/contracts/acceptErrors.ts — the names AND, for a new\n` +

...
// app, and whether it phones home.
//
...
try {
  ...
  // connected. `shortAddress` in apps/app/src/lib/format.ts renders
  ...
  // Coinbase serves. That is not app attempting a mutation, and
  ...
  // host-only test exempts the destination for everybody: if app

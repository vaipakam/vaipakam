...
function main(): void {
  ...
  console.log(
    `[inject-seo-meta] generated ${SUPPORTED_LOCALES.length} landing-page shells (root + ${SUPPORTED_LOCALES.length - 1} prefixed); no _redirects (relies on wrangler not_found_handling for sub-routes)`,
  );
}

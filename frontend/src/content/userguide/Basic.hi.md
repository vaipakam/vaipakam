...
अपने **escrow** को Vaipakam के भीतर अपनी निजी तिजोरी समझें। यह
...
आपको escrow खुद "बनाने" की ज़रूरत नहीं है; पहली बार ज़रूरत
...
**VPFI** प्रोटोकॉल का अपना token है। इसे escrow में रखने से
...
- आपके escrow में कितना है (जो "staked" गिना जाता है)।
...
Vaipakam आपके escrow में रखे VPFI का उपयोग करके protocol fees
...
- **स्टेकिंग प्रतिफल** — एस्क्रो में रखे किसी भी VPFI पर
...
borrower-of-record बन जाता है: borrower का collateral escrow में
...
पूरे समय escrow में रहता है — renter को उपयोग का अधिकार मिलता
...
Tier आपके **escrow** में रखे VPFI से तय होता है, wallet balance
से नहीं। कार्ड यह भी बताता है: (a) अगले tier तक पहुँचने के लिए
escrow में और कितना VPFI चाहिए, और (b) Dashboard पर consent
switch चालू है या नहीं — discount तभी लागू होता है जब वह चालू
हो।

आपके escrow में जो VPFI है वह स्वतः "staked" भी है और 5% APR
कमाता है।
...
VPFI खरीदने पर वह आपके wallet में आता है, escrow में नहीं। fee
discount और 5% staking yield पाने के लिए आपको उसे खुद escrow में
...
कुछ VPFI वापस wallet में चाहिए? यह कार्ड उसे escrow से वापस भेज
...
1. **Staking** — escrow में रखा VPFI स्वतः 5% APR कमाता है।
...
VPFI को escrow से वापस wallet में भेजें। wallet में आने के बाद
...
और वे escrow vaults जो उनके assets रखते हैं। loan खुलने पर हर
...
- **Refinance** — नई शर्तों के साथ नए loan में रोल करें;
  ...
  को चुका देता है। collateral कभी escrow से बाहर नहीं जाता।

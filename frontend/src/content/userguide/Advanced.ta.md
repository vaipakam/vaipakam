...
ஆர்வமூட்டும் சுருக்க அட்டை. இணைக்கப்பட்ட பணப்பையின் இரண்டு
ஓடைகளிலும் ஒருங்கிணைந்த VPFI வெகுமதிகள் படத்தை ஒற்றை
பார்வையில் வெளிப்படுத்துகிறது, தலைப்பு எண்ணிக்கை
`stakingPending + stakingLifetimeClaimed + interactionPending
+ interactionLifetimeClaimed` ஆகும்.

ஒவ்வொரு ஓடைக்குமான பகுப்பாய்வு வரிசைகள் நிலுவை + கோரப்பட்டது
காட்டுகின்றன மற்றும் அதன் சொந்த பக்கத்தில் முழு கோரிக்கை
அட்டைக்கான ஷெவ்ரான் ஆழமான இணைப்பு:

- **ஸ்டேக்கிங் வருமானம்** — `previewStakingRewards()`
  (நேரடி வாசிப்பு) + உள்ளூர் log-index இலிருந்து இந்த
  பணப்பையின் ஒவ்வொரு `StakingRewardsClaimed` நிகழ்வின்
  கூட்டுத்தொகை. `/buy-vpfi#staking-rewards` க்கு ஆழமான
  இணைப்பு.
- **இயங்குதள தொடர்பு வெகுமதிகள்** —
  `previewInteractionRewards()` பணப்பையின் அனைத்து கடன்
  களிலும் + ஒவ்வொரு `InteractionRewardsClaimed` நிகழ்வின்
  கூட்டுத்தொகை. `/app/claims#interaction-rewards` க்கு
  ஆழமான இணைப்பு.

வாழ்நாள் கோரப்பட்ட எண்களானது log-index நிகழ்வு ஸ்கேனிலிருந்து
கிளையன்ட்-பக்கம் பெறப்படுகிறது — இயங்கும் மொத்தத்திற்கு
ஆன்-செயின் getter இல்லை. (chain, diamond) ஸ்கேன் வரலாற்று
தொகுதிகளை நிரப்பும் வரை ஒரு புதிய உலாவி தற்காலிக சேமிப்பகம்
வாழ்நாளுக்கு 0 (அல்லது பகுதி) காட்டுகிறது; ஸ்கேன் முடிந்ததும்
எண் உண்மைக்கு குதிக்கிறது. அடிப்படை கோரிக்கை அட்டைகள் போன்ற
அதே நம்பிக்கை மாதிரி.

அட்டை எப்போதும் இணைக்கப்பட்ட பணப்பைகளுக்கு வழங்கப்படுகிறது,
all-zero நிலையில் கூட. காலியான-நிலை குறிப்பு வேண்டுமென்றே —
பூஜ்ஜியத்தில் அட்டையை மறைப்பது புதிய பயனர்கள் Buy VPFI
அல்லது Claim Center க்கு செல்லும் வரை வெகுமதி திட்டங்களை
கண்ணுக்கு தெரியாமல் ஆக்கும்.

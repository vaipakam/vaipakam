...
interest சம்பாதிக்கலாம். நீங்கள் assets-ஐ borrow செய்து collateral வைக்கலாம்.
நீங்கள் NFTs-ஐ rent செய்யலாம்; owner-க்கு daily fees கிடைக்கும். Loan அல்லது
rental முடியும் வரை assets smart contracts-ல் escrow-ஆக பாதுகாக்கப்பட்டு,
எல்லாம் இரண்டு wallets-க்கு இடையே நேரடியாக நடக்கும்.

இந்தப் பக்கம் ஒரு **friendly tour**. Technical depth வேண்டும் என்றால்,
ஒவ்வொரு screen-க்கும் உதவ **User Guide** tab-ஐ பயன்படுத்துங்கள்; முழு
whitepaper-க்கு **Technical** tab-ஐப் பாருங்கள். "இது என்ன, எப்படி
பயன்படுத்துவது" என்பதையே அறிய விரும்பினால் - தொடர்ந்து படியுங்கள்.
...
- **Lenders** - உங்களிடம் USDC, ETH, USDT போன்ற asset ஒன்று idle-ஆக இருக்கலாம்.
  ...
  நீங்கள் lender offer post செய்கிறீர்கள்; borrower accept செய்கிறார்; நீங்கள்
  உங்கள் terms-ல் interest பெறுகிறீர்கள்.
- **Borrowers** - சில நாட்கள், வாரங்கள், அல்லது மாதங்களுக்கு cash தேவைப்படலாம்;
  ...
  நினைக்கிறீர்கள், அல்லது பிரிய முடியாத NFT ஆக இருக்கலாம். நீங்கள் collateral
  post செய்கிறீர்கள்; loan பெறுகிறீர்கள்; agreed rate-ல் திருப்பிச் செலுத்துகிறீர்கள்.
- **NFT owners** - in-game அல்லது in-app utility தரும் valuable NFT உங்களிடம்
  ...
  விடுவது, ownership உங்களிடமே இருந்தபடி மற்றொருவர் சில நாட்கள் அதை பயன்படுத்தவும்,
  நீங்கள் daily rent பெறவும் உதவுகிறது.
- **NFT renters** - ஒரு NFT-க்கு, game asset, membership pass, அல்லது domain
  போன்றவற்றுக்கு, முழு விலை செலுத்தாமல் temporary access வேண்டும். நீங்கள் அதை
  rent செய்து, rental window-ல் பயன்படுத்துகிறீர்கள்; asset owner-டமே இருக்கும்.

Sign up தேவையில்லை. Profile நிரப்ப தேவையில்லை. Wallet connect செய்தால் lend,
...
அதன் மூலம் interest சம்பாதிக்க விரும்புகிறீர்கள். முழு lifecycle இதுதான்.

### Step 1 — Offer உருவாக்குங்கள்

Vaipakam app-ஐத் திறந்து, wallet connect செய்து, **Create Offer**-ஐ click
செய்கிறீர்கள். நீங்கள் lender என்பதால், இதை நிரப்புகிறீர்கள்:
...
நீங்கள் ஒரு transaction sign செய்கிறீர்கள். உங்கள் 1,000 USDC உங்கள் wallet-லிருந்து
உங்கள் **personal escrow**-க்கு நகர்கிறது. இது நீங்கள் மட்டுமே control செய்யும்
private vault. Borrower உங்கள் offer-ஐ accept செய்யும் வரை அது அங்கேயே இருக்கும்.
...
post செய்கிறார். இது சுமார் 67% LTV - உங்கள் 70% cap-க்கு கீழே இருப்பதால்,
offer accept ஆகிறது.
...
Loaned amount-லிருந்து சிறிய **Loan Initiation Fee (0.1%)** எடுக்கப்பட்டு
protocol treasury-க்கு செல்கிறது. அதனால் borrower 1,000 அல்ல, 999 USDC பெறுகிறார்.
(நீங்கள் fee-ஐ **VPFI**-யில் செலுத்தினால் borrower முழு 1,000 பெறலாம் - VPFI பற்றி
கீழே பார்க்கலாம்.)

### Step 3 — காலம் கடக்கிறது; borrower repay செய்கிறார்

30 நாட்கள் கழித்து, borrower principal plus interest உங்களுக்கு செலுத்த வேண்டும்:
...
அவரது wallet-க்கு திரும்பும். Loan closed ஆகிறது.
...
ஒரு single number. அது 1.0-க்கு கீழே சென்றால், யாரும் - ஆம், யாரும், ஒரு
passing bot கூட - **Liquidate** call செய்யலாம். Protocol collateral-ஐ அதிகபட்சம்
நான்கு DEX aggregators (0x, 1inch, Uniswap, Balancer) வழியாக route செய்து, சிறந்த
fill-ஐ எடுத்து, உங்களுக்கு வரவேண்டிய தொகையை செலுத்தி, liquidator-க்கு சிறிய bonus
கொடுத்து, மீதமுள்ளதை borrower-க்கு திருப்புகிறது.
...
அரிதான நேரங்களில் - ஒவ்வொரு aggregator-மும் மோசமான price தரும்போது, அல்லது
collateral கடுமையாக crash ஆனபோது - protocol மோசமான market-ல் *dump செய்ய மறுக்கும்*.
அதற்கு பதிலாக, உங்களுக்கு collateral தானே ஒரு small premium உடன் கிடைக்கும்; அதை
நீங்கள் hold செய்யலாம் அல்லது வேண்டிய நேரத்தில் sell செய்யலாம். இந்த **fallback path**
முன்கூட்டியே documented; loan terms-ன் ஒரு பகுதியாக அதை நீங்கள் accept செய்கிறீர்கள்.

### Step 5 — யாரும் repay செய்யலாம்

ஒரு நண்பர் அல்லது delegated keeper உங்கள் borrower-ன் loan-ஐ pay off செய்ய
விரும்பினால், அவர்கள் செய்யலாம். Collateral borrower-க்கே திரும்பும்; உதவிய
third party-க்கு அல்ல. இது one-way door: வேறொருவரின் loan-ஐ செலுத்துவதால் அவர்களின்
collateral உங்களுக்கு கிடைக்காது.
...
- **NFT escrow-லேயே இருக்கும்**; renter அதை நேரடியாக hold செய்யமாட்டார். அதற்கு
  ...
  "user rights" வழங்கும். Compatible games மற்றும் apps user rights-ஐ read
  செய்வதால், renter ownership இல்லாமலேயே play, log in, அல்லது NFT utility-ஐ
  பயன்படுத்தலாம்.
...
திரும்பும். பின்னர் owner அதை மீண்டும் list செய்யலாம் அல்லது wallet-க்கு claim
செய்து எடுத்துக்கொள்ளலாம்.

---

## என்னை என்ன பாதுகாக்கிறது?

Vaipakam-ல் lending மற்றும் borrowing risk-free அல்ல. ஆனால் protocol-ல் பல
பாதுகாப்பு layers built in ஆக உள்ளன:
...
இருப்பினும், நீங்கள் எதற்கு sign up செய்கிறீர்கள் என்பதை புரிந்துகொள்ள வேண்டும்.
ஒவ்வொரு loan-க்கும் முன் தோன்றும் combined **risk consent**-ஐ படியுங்கள் - அது
...
இரண்டு fees-மும் escrow-ல் VPFI hold செய்வதன் மூலம் **24% வரை discount** செய்யலாம்
(கீழே பார்க்கவும்). Default அல்லது liquidation நேரத்தில் recovered interest-ல்
Yield Fee வசூலிக்கப்படாது - failed loan-இலிருந்து protocol profit செய்யாது.
...
Discounts lender மற்றும் borrower fees இரண்டிற்கும் பொருந்தும். Discount
**loan life முழுவதும் time-weighted** ஆக கணக்கிடப்படும்; loan முடிவதற்கு முன்
திடீரென top up செய்வதால் calculation-ஐ game செய்ய முடியாது - நீங்கள் tier-ஐ
உண்மையில் hold செய்த காலத்திற்கு proportional-ஆக discount பெறுகிறீர்கள்.
...
daily reward denominator. அது busy chains மற்றும் quiet chains இடையே rewards fair
ஆக இருப்பதை உறுதி செய்கிறது.
...
தேர்வு செய்யுங்கள். Form உங்களை வழிநடத்தும்.
...
## நாங்கள் *செய்யாத* விஷயங்கள் பற்றிய குறிப்பு
...
- **No surprise upgrades.** Escrow upgrades gated; mandatory upgrades app-ல் தோன்றி
  நீங்கள் explicit-ஆக apply செய்ய வேண்டியவையாக இருக்கும். உங்கள் vault-ஐ உங்கள்
  பின்னால் எதுவும் rewrite செய்யாது.

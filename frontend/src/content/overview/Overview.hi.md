...
Vaipakam एक पीयर-टू-पीयर lending प्लेटफ़ॉर्म है। आप assets lend करते
हैं और interest कमाते हैं। आप assets borrow करते हैं और collateral
जमा करते हैं। आप NFTs rent करते हैं और owner को daily fees मिलती हैं।
सब कुछ सीधे दो wallets के बीच होता है, जबकि smart contracts loan या
rental समाप्त होने तक assets को escrow में सुरक्षित रखते हैं।

यह पेज आपका **friendly tour** है। अगर आप technical depth चाहते हैं,
तो हर screen की मदद के लिए **User Guide** tab देखें, या पूरे
whitepaper के लिए **Technical** tab खोलें। अगर आप बस यह समझना चाहते
हैं कि "यह क्या है और मैं इसे कैसे इस्तेमाल करूं" — आगे पढ़ें।
...
- **Lenders** — आपके पास कोई asset (USDC, ETH, USDT, आदि) idle पड़ा
  ...
  offer post करते हैं; borrower उसे accept करता है; आप अपनी terms पर
  interest कमाते हैं।
- **Borrowers** — आपको कुछ दिनों, हफ्तों या महीनों के लिए cash चाहिए,
  लेकिन आप अपना collateral बेचना नहीं चाहते (क्योंकि आपको लगता है कि
  उसकी value बढ़ेगी, या क्योंकि वह ऐसा NFT है जिससे आप अलग नहीं होना
  चाहते)। आप collateral post करते हैं; loan लेते हैं; और agreed rate
  पर उसे repay करते हैं।
- **NFT owners** — आपके पास कोई valuable NFT है जो game या app में
  utility देता है। उसे बेचने का मतलब उस utility को हमेशा के लिए खोना
  होगा। उसे rent पर देने से कोई और कुछ दिनों तक उसका इस्तेमाल कर
  सकता है, जबकि ownership आपके पास रहती है और आपको daily rent मिलता
  है।
- **NFT renters** — आप किसी NFT (game asset, membership pass, domain)
  का temporary access चाहते हैं, लेकिन पूरा price नहीं देना चाहते।
  आप उसे rent करते हैं, rental window में use करते हैं, और owner asset
  को retain करता है।

आप sign up नहीं करते। आप कोई profile नहीं भरते। आप wallet connect
करते हैं और lend, borrow या rent कर सकते हैं।

---

## Loan कैसे काम करता है (concrete example)

मान लीजिए आपके Base wallet में **1,000 USDC** पड़े हैं। आप interest
कमाना चाहते हैं। पूरा lifecycle ऐसा दिखता है।

### Step 1 — Offer बनाना

आप Vaipakam app खोलते हैं, wallet connect करते हैं, और **Create
Offer** पर click करते हैं। आप lender हैं, इसलिए आप भरते हैं:
...
**personal escrow** में जाते हैं (एक private vault जिसे केवल आप
control करते हैं)। वे वहीं रहते हैं जब तक कोई borrower आपकी offer
accept नहीं करता।
...
बराबर WETH post करता है (लगभग 67% LTV — आपकी 70% cap से नीचे, इसलिए
offer accept हो जाती है)।

Accept होते ही:

- आपके 1,000 USDC आपके escrow से उसके escrow में जाते हैं
- उसका WETH collateral के रूप में उसके escrow में lock हो जाता है
...
Loaned amount से एक छोटी **Loan Initiation Fee (0.1%)** ली जाती है
और protocol treasury को routed होती है। इसलिए borrower को 1,000 नहीं,
999 USDC मिलते हैं। (आप fee को **VPFI** में pay कर सकते हैं, तब
borrower को पूरे 1,000 मिलते हैं — VPFI के बारे में नीचे और है।)

### Step 3 — समय बीतता है; borrower repay करता है

30 दिनों के बाद, borrower आपको principal plus interest owe करता है:
...
आपको dashboard पर **Claim** button दिखता है। आप click करते हैं और
1,005.51 USDC settlement से आपके wallet में move हो जाते हैं।
Borrower claim करता है और उसका WETH उसके wallet में वापस चला जाता
है। Loan close हो जाता है।

### Step 4 — अगर borrower repay नहीं करता तो?

दो चीजें गलत हो सकती हैं, और protocol दोनों को automatically handle
करता है।

**Collateral price loan के बीच में crash हो जाता है।** Vaipakam हर
loan का **Health Factor** track करता है (एक single number जो
collateral value को debt से compare करता है)। अगर यह 1.0 से नीचे
...
Rare cases में — हर aggregator bad price देता है, या collateral बहुत
ज्यादा crash हो चुका है — protocol खराब market में *dump करने से
इंकार* करता है। इसके बदले आपको collateral itself plus एक छोटा
premium मिलता है, और आप उसे hold कर सकते हैं या जब चाहें sell कर
सकते हैं। यह **fallback path** upfront documented है और आप loan
terms के हिस्से के रूप में इसे accept करते हैं।
...
Flow loan जैसा ही है, दो differences के साथ:

- **NFT escrow में रहता है**; renter उसे सीधे hold नहीं करता। इसके
...
Rental end होने पर (expiry या default से), NFT owner के escrow में
वापस जाता है। Owner फिर उसे re-list कर सकता है या अपने wallet में
claim back कर सकता है।

---

## मुझे क्या protect करता है?

Vaipakam पर lending और borrowing risk-free नहीं है। लेकिन protocol
में कई built-in layers हैं:

- **Per-user escrow.** आपके assets आपकी अपनी vault में रहते हैं।
  Protocol उन्हें दूसरे users के funds के साथ pool नहीं करता। इसका
  मतलब है कि किसी दूसरे user को affect करने वाला bug आपको drain
  नहीं कर सकता।
- **Health Factor enforcement.** Loan तभी start हो सकता है जब
  origination पर collateral loan value का कम से कम 1.5× हो। अगर
  loan के बीच में price borrower के खिलाफ move करता है, तो collateral
  debt से कम होने से पहले कोई भी liquidate कर सकता है — lender की
  protection के लिए।
...
अगर आप किसी chain पर अपने escrow में VPFI hold करते हैं, तो उस chain
पर जिन loans में आप participate करते हैं उनकी protocol fees discount
होती हैं:
...
आप उतने समय के अनुपात में कमाते हैं जितना आपने सच में उस tier को
hold किया।

### 2. Staking — 5% APR

आपके escrow में बैठा कोई भी VPFI automatically 5% annual yield पर
staking rewards कमाता है। कोई separate staking action नहीं, कोई
lock-up नहीं, कोई "unstake" wait नहीं। VPFI को escrow में move करें
...
interest pay किया (no late fees, no default), तो आप share कमाते हैं।
...
Base पर open हुआ loan Base पर settle होता है। Arbitrum पर open हुआ
loan Arbitrum पर settle होता है। Cross-chain debt नहीं है। Chains के
बीच सिर्फ VPFI token और daily reward denominator cross करते हैं
...
1. Vaipakam app खोलें, wallet connect करें।
...
"NFT rental" चुनते हैं। Form आपको guide करेगा।

अगर आप सिर्फ **अपने VPFI पर passive yield** कमाना चाहते हैं, तो उसे
**Dashboard** page पर अपने escrow में deposit करें। बस इतना ही —
staking उसी moment से automatic है।

---

## जो हम *नहीं* करते, उस पर एक note

कुछ चीजें जो दूसरे DeFi platforms करते हैं और हम जानबूझकर **नहीं**
करते:
...
- **No pooled lending.** हर loan दो specific wallets के बीच होता है,
  ...
  pool नहीं, कोई utilization curve नहीं, कोई surprise rate spikes
  नहीं।
- **No proxy custody.** आपके assets आपके अपने escrow में रहते हैं,
...
- **No leveraged loops by default.** अगर आप चाहें तो borrowed funds
  ...
  automatic looping को UX में build नहीं करता। हमें लगता है यह
  footgun है।
- **No surprise upgrades.** Escrow upgrades gated हैं; mandatory

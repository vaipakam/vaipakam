...
const HF_WATCHER_ORIGIN =
  import.meta.env.VITE_HF_WATCHER_ORIGIN ??
  'https://vaipakam-hf-watcher.placeholder.workers.dev';
...
export default function Alerts() {
  ...
  const save = async () => {
    ...
    if (criticalHf <= 1) {
      setErr('Critical threshold must be greater than 1.00 (liquidation bound).');
      return;
    }
    setSaving(true);
    try {
  ...
  return (
    <div className="page-container">
      ...
      >
        ...
        <p style={{ fontSize: '0.85rem', opacity: 0.8, margin: '4px 0 16px' }}>
          Enable one or both. Both rails share the threshold ladder above —
          you don't configure different warn-levels per channel.
        </p>
        ...
        >
          ...
          {tgLinkCode ? (
            <div style={{ fontSize: '0.9rem' }}>
              DM this code to the Vaipakam alerts bot within 10 minutes:
              <div
                style={{
                  margin: '6px 0',
                  fontSize: '1.4rem',
